...
---
<!-- _class: diff -->
# Rapidusチップレット技術: 600mm角ガラス基板を使った大型インターポーザ
...
---
<!-- _class: diff -->
# Rapidusチップレット技術: 600mm角ガラス基板を使った大型インターポーザ cont.
...
### その他
- 自社内で先端ロジック（2nm）と後工程（この大型インターポーザを含むパッケージング）を同時に最適化
  - いわゆる「前後工程融合戦略」の中核技術
...
- 将来的にはガラスに微細な穴を開け電極を通す「TGV（Through Glass Via）」技術を用いてインターポーザ基板とする．
  ...
  - シリコンインターポーザにとってかわるためには外部I/O・電源のためにTGVは必須（スパコン採用にはこれも必要）

### 参考文献
- "Rapidus、600mm角インターポーザーパネルを初披露　NVIDIAの受託にも意欲," EE Times Japan, 2025/12/19.
- "ラピダス小池社長、世界初600mm角基板を披露　未来の半導体工場構想も," マイナビニュースTECH+, 2025/12/24.
